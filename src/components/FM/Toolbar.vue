<template>
    <v-toolbar flat dense color="blue-grey lighten-5" style="background:#eee;">
        <v-toolbar-items>
        ...
        <template v-if="$vuetify.breakpoint.smAndUp">
            ...
            <v-btn  icon v-if="path" @click="newFolderPopper=true;" title="Create Folder">
                <v-icon>mdi-folder-plus-outline</v-icon>
            </v-btn>
                <v-card v-if="newFolderPopper" style="display:contents;">
                    <v-card-text>
