<template>
    <v-card class="mx-auto fm_board" :loading="loading > 0">
        <toolbar
            :path="path"
        ...
        <v-row no-gutters>
            ...
            <v-col style="width:calc(100% - 260px)">
                <list
                    :path="path"
                    :storage="activeStorage"
                    :icons="icons"
...
const endpoints = {
    ...
    download: { url: config.file_download+"?file={path}", method: "get" },
};
...
.fm_board{
    ...
    box-shadow: 0 8px 42px -8px rgba(0, 0, 0, 0.2) !important;
