<template>
  <el-main style="position:absolute;height:100%;width:100%;top:0px;left:0px;">
    ...
    <el-row class="ops">
        <el-button type="primary" icon="el-icon-document-add" style="float: left;margin-bottom:10px;" v-on:click="show_add_paper=!show_add_paper">添加Paper</el-button>
        ...
        <el-col :span="6" style="line-height:40px;padding:0px 10px;"><el-checkbox v-model="include_finished" @change="change_finished">已完成</el-checkbox></el-col>
        <el-col :span="6" style="line-height:40px;padding:0px 10px;"><el-checkbox v-model="list_mode" @change="change_list_mode">列表模式</el-checkbox></el-col>
